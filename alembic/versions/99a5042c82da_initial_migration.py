...
def upgrade() -> None:
    ...
    op.create_table('chip',
                    ...
                    sa.Column('type', sa.CHAR(length=1), nullable=True, server_default=sa.text('(SUBSTR(`name`,1,1))')),
    ...
    op.create_table('cv_data',
                    ...
                    sa.Column('datetime', sa.DATETIME(), nullable=False, server_default=sa.func.current_timestamp()),
                    sa.ForeignKeyConstraint(['chip_id'], ['chip.id'], name='cv_data_FK_1'),
                    sa.ForeignKeyConstraint(['chip_state_id'], ['chip_state.id'],
                                            name='cv_data_FK'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('iv_data',
                    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.bulk_insert(chip_state_table, [
