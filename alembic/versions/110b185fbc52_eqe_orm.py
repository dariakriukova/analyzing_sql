...
def upgrade() -> None:
    carrier_table = op.create_table('carrier',
                                    sa.Column('id', sa.SmallInteger(), nullable=False),
                                    sa.Column('name', sa.VARCHAR(length=100), nullable=False),
                                    sa.PrimaryKeyConstraint('id')
                                    )
    op.create_table('eqe_session',
    ...
    op.create_table('eqe_conditions',
                    sa.Column('id', sa.Integer(), nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['carrier_id'], ['carrier.id'],
                                            name='eqe_conditions__carrier', onupdate='CASCADE',
                                            ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['chip_id'], ['chip.id'], name='eqe_conditions__chip',
                                            onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['chip_state_id'], ['chip_state.id'],
                                            name='eqe_conditions__chip_state', onupdate='CASCADE',
                                            ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['instrument_id'], ['instrument.id'],
                                            name='eqe_conditions__instrument', onupdate='CASCADE',
                                            ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['session_id'], ['eqe_session.id'],
                                            name='eqe_conditions__session', onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_eqe_conditions_chip_id'), 'eqe_conditions', ['chip_id'], unique=False)
    op.create_index(op.f('ix_eqe_conditions_chip_state_id'), 'eqe_conditions', ['chip_state_id'],
                    unique=False)
    op.create_index(op.f('ix_eqe_conditions_session_id'), 'eqe_conditions', ['session_id'],
                    unique=False)
    op.create_table('eqe_data',
                    sa.Column('id', sa.Integer(), nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['conditions_id'], ['eqe_conditions.id'],
                                            name='eqe_data__conditions', onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.bulk_insert(instrument_table, [
